...
const projectDescriptionList = [
  {
    ...
    description: {
      ru: [
        `Наш "Интернет-магазин товаров для дома и сада" упрощает покупку. 
        Магазин предлагает скидки на различные товары и позволяет покупателям удобно фильтровать и выбирать продукты.`,
        `С простым интерфейсом и эффективными фильтрами нахождение нужного товара становится быстрым и легким. Для проекта использован следующий стек технологий: JavaScript, React, Redux, Webpack, HTML5/CSS3, SCSS, REST API, Git, 
...

  {
    ...
    description: {
      ru: [
        `У меня также есть проект E-commerce, который предоставляет пользователям возможность выбирать товары, 
        искать их, фильтровать и оформлять заказы после авторизации.`,
        `Этот проект реализован дважды: один раз на нативном JavaScript,
      ...
      en: [
        `I also have an E-commerce project that provides users with the ability to select products, 
        search for them, filter and place orders after authorization.`,
        `This project is implemented twice: once in native JavaScript,
      ...
      de: [
        `Ich habe auch ein E-Commerce-Projekt, das Benutzern die Möglichkeit bietet, Produkte auszuwählen, 
        Suchen Sie danach, filtern Sie und geben Sie nach der Autorisierung Bestellungen auf.`,
        `Dieses Projekt wird zweimal implementiert: einmal in nativem JavaScript,
      ...
      taj: [
        `Ман инчунин як лоиҳаи тиҷорати электронӣ дорам, ки ба корбарон қобилияти интихоби маҳсулот, 
        онҳоро ҷустуҷӯ кунед, филтр кунед ва фармоишҳоро пас аз авторизатсия ҷойгир кунед.`,
        `Ин лоиҳа ду маротиба амалӣ карда мешавад: як маротиба дар JavaScript модарӣ,
  ...
  },
  {
    ...
    description: {
      ru: [
        `Это мой проект Weather API, где вы можете узнать о погоде в различных городах и странах.`,
        `Этот проект также реализован дважды: один раз на нативном JavaScript, а другой - на React с использованием JavaScript. Написание проекта с использованием двух разных технологий позволило мне ощутить и понять различия между нативным JavaScript и React.
         Для реализации этого проекта я использовал следующие технологии: HTML5, CSS3, React, JavaScript и Git.`,
      ],
      en: [
        `This is my Weather API project where you can find out about the weather in different cities and countries.`,
        `This project is also implemented twice, once in native JavaScript and another in React using JavaScript. Writing a project using two different technologies allowed me to experience and understand the differences between native JavaScript and React.
         To implement this project I used the following technologies: HTML5, CSS3, React, JavaScript and Git.`,
      ],
      de: [
        `Dies ist mein Wetter-API-Projekt, mit dem Sie sich über das Wetter in verschiedenen Städten und Ländern informieren können.“, „Dieses Projekt ist auch zweimal implementiert, einmal in nativem JavaScript und ein weiteres in React mit JavaScript.“ Durch das Schreiben eines Projekts mit zwei verschiedenen Technologien konnte ich die Unterschiede zwischen nativem JavaScript und React erleben und verstehen.
         Zur Umsetzung dieses Projekts habe ich folgende Technologien verwendet: HTML5, CSS3, React, JavaScript und Git.`,
      ],
      taj: [
        `Ин лоиҳаи ман Weather API аст, ки дар он шумо метавонед дар бораи обу ҳаво дар шаҳрҳо ва кишварҳои гуногун маълумот гиред.`,
        `Ин лоиҳа инчунин ду маротиба амалӣ карда мешавад, як маротиба дар JavaScript-и аслӣ ва дигаре дар React бо истифода аз JavaScript. Навиштани лоиҳа бо истифода аз ду технологияи гуногун ба ман имкон дод, ки фарқияти байни JavaScript ва React-ро эҳсос кунам ва дарк кунам.
         Барои татбиқи ин лоиҳа ман технологияҳои зеринро истифода кардам: HTML5, CSS3, React, JavaScript ва Git.`,
      ],
    },
  ...
  },
  {
    ...
    description: {
      ru: [
        `Это мой проект Pizza Shop, в котором вы можете собирать пиццу из нужных вам ингредиентов.`,
        `Этот проект я вместе с командой реализовал во время обучения в Starta Institute by Tel-Ran. Пицца не будет заказана, пока не выбраны необходимые ингредиенты, как минимум один из всех доступных. 
        Для реализации этого проекта мы использовали следующие технологии: HTML5, CSS3, JavaScript, Webpack и Git.`,
      ],
      en: [
        `This is my Pizza Shop project, in which you can assemble pizza from the ingredients you need.`,
        `I implemented this project with my team while studying at Starta Institute by Tel-Ran. Pizza will not be ordered until the required ingredients have been selected, at least one of all available ones. 
        To implement this project we used the following technologies: HTML5, CSS3, JavaScript, Webpack and Git.`,
      ],
      de: [
        `Das ist mein Pizza-Shop-Projekt, bei dem man Pizza aus den benötigten Zutaten zusammenstellen kann.“ „Ich habe dieses Projekt mit meinem Team während meines Studiums am Starta Institute by Tel-Ran umgesetzt.“ Die Pizza wird erst dann bestellt, wenn die benötigten Zutaten ausgewählt wurden, mindestens eine von allen verfügbaren. 
        Zur Umsetzung dieses Projekts haben wir folgende Technologien verwendet: HTML5, CSS3, JavaScript, Webpack und Git.`,
      ],
      taj: [
        `Ин лоиҳаи Pizza Shop ман аст, ки дар он шумо метавонед пиццаро ​​аз ингредиентҳои лозимаи худ ҷамъ кунед.`,
        `Ман ин лоиҳаро ҳангоми таҳсил дар Донишкадаи Старта тавассути Тел-Ран бо дастаи худ амалӣ кардам. Пицца то он даме, ки компонентҳои зарурӣ интихоб карда нашаванд, ҳадди аққал яке аз ҳама мавҷудот фармоиш дода намешавад. 
  ...
  },
  {
    ...
    description: {
      ru: [
        `Это мой проект Mobile App — прекрасно проработанное и адаптированное под различные устройства приложение.`,
        `Для его реализации я использовал следующие технологии: HTML5, CSS3, Javascript и Git.`,
      ],
      en: [
        `This is my Mobile App project - a beautifully designed application adapted for various devices.`,
        `To implement it, I used the following technologies: HTML5, CSS3, Javascript and Git.`,
      ],
      de: [
        `Das ist mein Mobile-App-Projekt – eine wunderschön gestaltete Anwendung, die für verschiedene Geräte angepasst ist.`,
        `Zur Umsetzung habe ich folgende Technologien verwendet: HTML5, CSS3, Javascript und Git`,
      ],
      taj: [
        `Ин лоиҳаи Барномаи мобилии ман аст - замимаи зебо тарҳрезишуда барои дастгоҳҳои гуногун.`,
  ...
  },
  {
    ...
    description: {
      ru: [
        `Это мой проект Designed Shop — стилизованный магазин одежды и обуви, реализованный в 3D-стиле с множеством эффектов.`,
        `Для его реализации я использовал следующие технологии: HTML5, CSS3 и Git.`,
      ],
      en: [
        `This is my Designed Shop project - a stylized clothing and shoe store, implemented in 3D style with many effects.`,
        `To implement it, I used the following technologies: HTML5, CSS3 and Git.`,
      ],
      de: [
        `Das ist mein Designed Shop-Projekt – ein stilisierter Bekleidungs- und Schuhladen, umgesetzt im 3D-Stil mit vielen Effekten.`,
        `Zur Umsetzung habe ich folgende Technologien verwendet: HTML5, CSS3 und Git.`,
      ],
      taj: [
        `Ин проекти Designed App мебошад - мағозаи либос ва пойафзоли услубӣ, ки бо услуби 3D бо эффектҳои зиёд амалӣ карда шудааст.`,
...
btn.forEach((btns, index) => {
  btns.addEventListener("click", (e) => {
    ...
    const currenSecondDescrtiption =
      currentProject.description[locationHash][1];
